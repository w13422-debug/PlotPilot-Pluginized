...
def v2_groups() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "positive": ["plugin.discovery", "plugin.lifecycle.install", "plugin.lifecycle.upgrade", "plugin.lifecycle.retire", "plugin.lifecycle.rollback", "plugin.lifecycle.result.install", "plugin.lifecycle.result.upgrade", "plugin.lifecycle.result.retire", "plugin.lifecycle.result.rollback"],
            "negative": [
